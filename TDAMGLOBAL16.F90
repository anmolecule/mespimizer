...
!------------------------------------------------------------------------
!
!	Modules for programs DAM2016, G-DAM2016, DAMDEN2016, DAMPOT2016, DAMFIELD2016, DAMFIELDPNT2016
!		DAMFRAD2016, DAM2016_mpi, G-DAM2016_mpi, DAMDEN2016_mpi, DAMPOT2016_mpi, DAMMULTROT2016,
!		DAMORB2016, DAMORB2016_mpi
!
...
!> @param [in] KINT Decides 4-byte integer. Moved from DAM2016_T    
!> @param [in] KINT8 Decides 8-byte integer. Moved from DAM2016_T    
!> @param [in] KREAL Decides double precision floating point number. Moved from DAM2016_T     
!> @param [in] KREAL4 Decides single precision floating point number. Moved from DAM2016_T     
...
!! Moved from DAMDEN2016_T and DAMPOT2016_T module. Other such logicals are
...
!> @param atmnam atomic symbols of centers
    ...
    MODULE DAMINITIAL_T
        ...
        INTEGER(KINT), PARAMETER :: IOUT=6  
        INTEGER(KINT) :: LMAXI, NCEN
		INTEGER(KINT), ALLOCATABLE :: NZN(:) 
!        REAL(KREAL) :: COX,COY,COZ,TMASS 
        REAL(KREAL) :: FDISP
		REAL(KREAL), ALLOCATABLE    :: RCEN(:,:) 
        REAL(KREAL),ALLOCATABLE     :: ATWT(:), ATVDW(:) 
        ...
        REAL(KREAL) :: ATMVDW(0:103) = (/               &
              0.0, 2.267671187, 2.645616385, 3.4393013, 2.891280763, 3.628273899 &
            , 3.212534181, 2.929075283, 2.872383503, 2.777897204, 2.910178023, 4.289677995 &
            , 3.269225961, 3.47709582, 3.968424577, 3.40150678, 3.40150678, 3.307020481 &
            , 3.552684859, 5.19674647, 4.365267035, 3.987321837, 9.448629945, 9.448629945 &
            , 9.448629945, 9.448629945, 9.448629945, 9.448629945, 3.080253362, 2.645616385 &
            , 2.626719125, 3.533787599, 3.987321837, 3.49599308, 3.590479379, 3.49599308 &
            , 3.817246498, 5.725869747, 4.705417713, 9.448629945, 9.448629945, 9.448629945 &
            , 9.448629945, 9.448629945, 9.448629945, 9.448629945, 3.080253362, 3.250328701 &
            , 2.985767063, 3.647171159, 4.100705396, 3.892835537, 3.892835537, 3.741657458 &
            , 4.081808136, 6.481760142, 5.064465651, 9.448629945, 9.448629945, 9.448629945 &
            , 9.448629945, 9.448629945, 9.448629945, 9.448629945, 9.448629945, 9.448629945 &
            , 9.448629945, 9.448629945, 9.448629945, 9.448629945, 9.448629945, 9.448629945 &
            , 9.448629945, 9.448629945, 9.448629945, 9.448629945, 9.448629945, 9.448629945 &
            , 3.307020481, 3.136945142, 2.929075283, 3.703862938, 3.817246498, 3.911732797 &
            , 3.722760198, 3.817246498, 4.157397176, 6.576246442, 5.347924549, 9.448629945 &
            , 9.448629945, 9.448629945, 3.51489034, 9.448629945, 9.448629945, 9.448629945 &
            , 9.448629945, 9.448629945, 9.448629945, 9.448629945, 9.448629945, 9.448629945 &
            , 9.448629945, 9.448629945       /)
    END MODULE
...
!> @param wthreshold threshold for contributions for the B integrals (see subroutine Avk)
	MODULE DAM2016_DATA_T
		...
		logical :: longoutput, lsto, lgbsgz, ldengz
		real(KREAL) :: roblk(-mxl:mxl,-mxl:mxl)
		logical, allocatable :: lsdisf(:,:)
...
! for overlap integrals with ellipsoidal coords
	...
	END MODULE
!
!                 END OF MODULE DAM2016_CONST_T
!...............................................................................................
!===============================================================================================
!                 MODULE DAM2016_LEGENDRE_T
!===============================================================================================
!> @author Jaime Fernandez Rico, Rafael Lopez, Ignacio Ema, Guillermo Ramirez
...
!	Data generated with notebook legendre_quadrature.nb
	...
	END MODULE
!
!                 END OF MODULE DAM2016_LEGENDRE_T
!...............................................................................................
!===============================================================================================
!                 MODULE DAMDEN2016_T
!===============================================================================================
!> @author Jaime Fernandez Rico, Rafael Lopez, Ignacio Ema, Guillermo Ramirez
!> @details Contains variables used by TDAMDEN2016_mpi.F90
	MODULE DAMDEN2016_T
        USE DAMINITIAL_T
		USE DAM2016_T
		IMPLICIT NONE
	...
	END MODULE
!
!                 END OF MODULE DAMDEN2016_T
!...............................................................................................
!===============================================================================================
!                 MODULE DAMPOT2016_T
!===============================================================================================
!> @author Jaime Fernandez Rico, Rafael Lopez, Ignacio Ema, Guillermo Ramirez
!> @details Contains variables used by TDAMPOT2016_mpi.F90
	MODULE DAMPOT2016_T
        USE DAMINITIAL_T
		USE DAM2016_T
		IMPLICIT NONE
		...
		real(KREAL), allocatable :: Qgacum(:,:), qpacum(:,:), Qlcorto(:), ra2l1(:), ra2l1inv(:)
		integer(KINT), allocatable :: lcorto(:,:), llargo(:,:)
	END MODULE
!
!                 END OF MODULE DAMPOT2016_T
...
!> @param drcutcp Value of gradient to decide if the path is near to a CP. drcutcp = 10e-4 
